        ...
        <AnimatePresence>
          <FadeUp key="title-greeting" duration={0.6}>
            <h1 className="text-6xl font-bold text-accent sm:text-7xl md:text-6xl lg:text-5xl xl:text-7xl">
              Hi, I&apos;m Nithin Emmanuel
            </h1>
          </FadeUp>
          <FadeUp key="description-1" duration={0.6} delay={0.2}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              I&apos;m a Python developer focused on building GenAI and LLM
              powered applications. I bring the same commitment to clean,
              well-tested code and thoughtful system design to every project
              I work on, from backend APIs to retrieval-augmented pipelines.
            </p>
          </FadeUp>
